...
Source Code
===========
See the source code for method [LightRealistService::decorateListActionGroups](https://github.com/lingtalfi/Light_Realist/blob/master/Service/LightRealistService.php#L474-L492)
